...
![CatalogueCanvas](assets/logotext.png){ .cc-hero__wordmark }
...
![CatalogueCanvas catalogue view](assets/Items_CC.png)
</figure>

<div class="cc-features" markdown>

<div class="cc-feature" markdown>
:material-package-down:{ .cc-feature__icon }
### Ingest
One ZIP becomes one catalogue item. The main image is converted to a WebP preview automatically.
</div>
